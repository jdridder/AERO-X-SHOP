...
export const products: Product[] = [
    {
        ...
        storytelling: [
            {
                title: "SECOND SKIN FABRIC",
                text: "We believe that arm sleeves are mostly about feel of wearing. Engineered from 80 % Nylon & 20 % premium Lycra, the arm sleeves mould to your skin like a second surface. This creates an enhanced perception of your arms. The ultra-lightweight 20 g construction creates a second-skin fit that reduces air resistance at the arm surface caused by skin hair. This allows for a reduced drag coefficient at all flow speeds. Further, the breathable Lycra mixture ensures sweat evaporation. Thus, the sleeves are optimally worn in cool conditions from 5 °C to 15 °C to keep your arms warm without over-heating depending on the intensity of exercise.",
                image: "/pictures/arm-sleeves/fabric-pink-arm-sleeve.jpg",
                layoutDirection: "normal",
            },
            {
                title: "VISIONARY DESIGN",
                text: "Arm sleeves do not need to be black, white and boring. You can stand out with aethestic designs that underline your style. Wheter exeptional or minimalistic, we have the perfect design for your preferences. This was our original business idea at Wasp Aerodynamics.",
                image: "/pictures/arm-sleeves/hearts-arm-sleeve-05.jpg",
                layoutDirection: "reversed",
            },
            {
                title: "ATHLETE-ENGINEERED",
                text: "Developed alongside professional middle-distance runners at Dortmund's former nation-wide outstanding running team, you will never get compromises. Arm sleeve material and design have been tested to perfection in various long and tempo runs as well as track & field meets. Especially, at cross country championships your arm sleeves will be a highlight.",
                image: "/pictures/arm-sleeves/athlete-inspired.jpg",
                layoutDirection: "normal",
            },
        ],
        tech_stats: {
